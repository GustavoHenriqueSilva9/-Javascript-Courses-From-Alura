...
const cliente1 = new Cliente("Ricardo",11122233309); // uma instancia da classe
// cliente1.nome = "Ricardo"; //obejeto a partir do Molde
// cliente1.cpf = 11122233309;


const cliente2 = new Cliente("Gustavo",66699988807 );
// cliente2.nome = "Gustavo"; //obejeto a partir do Molde
// cliente2.cpf = 66699988807;

const conta2 = new ContaCorrente(cliente2,1336);
// conta2.agencia = 1336;
...
// conta1.saldo = 100; Não podemos colocar dessa forma pois o atributo está privado , somente caso tivermos o metodo set dele
